...
// resolveCase describes one end-to-end resolver test: parse input with English,
// then resolve against resolveNow, and compare to want.
...
var resolveCases = []resolveCase{
	...
	// March 22 at exactly resolveNow is not after now → next year
